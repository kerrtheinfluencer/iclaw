...
const engineMeta = {
  ...
  wasm: {
    ...
    models: [
      { id: 'gemma-3-1b-webgpu',          label: 'Gemma 3 1B ⚡',  tier: 'WebGPU · Google' },
      { id: 'qwen2.5-coder-1.5b-webgpu', label: 'Qwen 1.5B ⚡',   tier: 'WebGPU · Coding' },
      { id: 'llama3.2-1b-webgpu',        label: 'Llama 3.2 1B ⚡', tier: 'WebGPU · General' },
      { id: 'smollm2-1.7b-webgpu',       label: 'SmolLM2 1.7B ⚡', tier: 'WebGPU · Fast' },
